<!-- @canonical-origin: canon@a86ca143:papers/n6-meteorology-paper.md (moved 2026-05-10) -->
<!-- gold-standard: shared/harness/sample.md -->
---
domain: meteorology
requires: []
---
# [CANONICAL v2] Ultimate meteorology (HEXA-METEOROLOGY) — n=6 Arithmetic Coordinate Mapping

> **Author**: Minwoo Park (canon)
> **Category**: meteorology — n=6 arithmetic seed paper
> **Version**: v2 (2026-04-14 canonical)
> **Upstream BT**: BT-373, BT-373, BT-373, BT-373, BT-373
> **Linked atlas node**: `meteorology` 31/31 EXACT [10*]

---

## 0. Abstract

This paper demonstrates that the core parameters of the meteorology domain
...
meteorology. atlas.n6 records 31/31 entries EXACT.

This paper does not claim a new meteorology; it is a seed paper that
...
meteorology is re-read within the n=6 arithmetic framework. The perfect
...
of the meteorology domain. **This paper overlays an n=6 arithmetic
coordinate system on top of existing meteorology knowledge.**

| Effect | Before | After HEXA-METEOROLOGY | Perceived change |
|--------|--------|--------------|------------------|
...
```
  Before: "Why is this meteorology value this number?" → experience/custom
  HEXA:   "This meteorology value = σ(6) or τ(6) or sopfr(6)" → number-theoretic necessity
         ↓
...
## §2 COMPARE (classical meteorology vs n=6) — performance comparison (ASCII)
...
### Performance-bar ASCII (classical meteorology vs HEXA-METEOROLOGY)
...
4. **Domain overlap**: the σ=12 axes are shared parameters across dozens of domains beyond meteorology.
...
HEXA-METEOROLOGY staged maturity roadmap — verification density grows per Mk:

<details open>
<summary><b>Mk.V — 2045+ full integration</b></summary>

All of meteorology is integrated with n=6 arithmetic. Cross-referenced
...
meteorology core parameters are mapped onto σ/τ/φ/sopfr/J₂.
...
Check whether the main meteorology scaling laws follow the τ(6)=4 or
...
Compute atlas 31/31 EXACT under H₀ (random matching) → p-value.
...
#!/usr/bin/env python3
# -----------------------------------------------------------------------------
# §7 VERIFY -- HEXA-METEOROLOGY n=6 honesty check (stdlib only, meteorology domain)
#
...
FALSIFIERS = [
    "If meteorology key parameter n=6 alignment < 70%, retract the paper's main target",
    "If sigma(n)*phi(n) = n*tau(n) holds for any n other than n=6, retract the uniqueness candidate",
    "If atlas 31/31 EXACT drops below 70% on re-measurement, demote to Mk.I",
