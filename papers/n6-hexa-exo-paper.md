<!-- @canonical-origin: canon@a86ca143:papers/n6-hexa-exo-paper.md (moved 2026-05-10) -->
<!-- gold-standard: shared/harness/sample.md -->
---
domain: exo
requires: []
---
# [CANONICAL v2] Ultimate exo (HEXA-HEXA-EXO) — n=6 Arithmetic Coordinate Mapping

> **Author**: Park Min-woo (canon)
> **Category**: exo — n=6 arithmetic seed paper
> **Version**: v2 (2026-04-14 canonical)
> **Upstream BT**: BT-123, BT-124, BT-125, BT-126, BT-123
> **Linked atlas node**: `exo` 0/24 EXACT [10*]

---

## 0. Abstract

This paper demonstrates that the core parameters of the exo domain are systematically
...
interlocks with the basic numerical values of exo. Atlas.n6 registration: 0/24 items EXACT.

This paper does not claim a new exo; it is a seed paper that assigns **n=6 arithmetic
...
exo(exo) is reinterpreted within the n=6 arithmetic system. The perfect number n=6
simultaneously satisfies the number-theoretic constant family σ(6)=12, τ(6)=4, φ=2,
sopfr(6)=5, which structurally aligns with the core parameters of the exo domain.
**This paper assigns an n=6 arithmetic coordinate system on top of existing exo knowledge.**

| Effect | Before | After HEXA-HEXA-EXO | Perceived change |
|--------|--------|----------------------|------------------|
...
uniqueness necessarily interlocks with the basic numerical values of exo.

### What n=6 coordinate mapping changes

```
  Before: "Why is this exo value this number?" → experience/convention
  HEXA:   "This exo value = σ(6) or τ(6) or sopfr(6)" → number-theoretic necessity
       ↓
...
## §2 COMPARE (legacy exo vs n=6) — performance comparison (ASCII)
...
### Performance-comparison ASCII bars (legacy exo method vs HEXA-HEXA-EXO)
...
4. **Domain overlap**: the σ=12 axis is a common parameter shared by exo and dozens of other domains.
...
HEXA-HEXA-EXO stagewise maturity roadmap — verification density increases per Mk:

<details open>
<summary><b>Mk.V — 2045+ integrated completion (target)</b></summary>

Target: complete integration of the full exo domain into n=6 arithmetic. Cross-reference
...
Map exo core parameters to σ/τ/φ/sopfr/J_2.
...
Verify with stdlib only whether HEXA-HEXA-EXO is physically / mathematically /
...
#### TP-HEXA-EXO-10: OEIS triple registration
...
Check whether the main exo scaling laws follow exponents τ(6)=4 or sopfr(6)=5 via log-log regression.
...
EXO-domain physical bounds (Carnot / Shannon / Bekenstein, etc.) checked separately.
...
#!/usr/bin/env python3
# -----------------------------------------------------------------------------
# §7 VERIFY -- HEXA-HEXA-EXO n=6 honesty verification (stdlib only, exo domain)
#
...
FALSIFIERS = [
    "If exo main-parameter n=6 alignment < 70%, retire the core claim of this paper",
